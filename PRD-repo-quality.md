...
**Acceptance Criteria:**
- [ ] `datetime.utcnow()` does not appear in `rex/identity.py`
- [ ] timezone-aware UTC equivalent used in its place
- [ ] `timezone` imported correctly in the module
- [ ] all existing tests that exercise `identity` pass
- [ ] no `DeprecationWarning` for `utcnow` emitted by this module during test run
- [ ] Typecheck passes
...
**Acceptance Criteria:**
- [ ] `datetime.utcnow()` does not appear in `rex/automation_registry.py`
- [ ] timezone-aware UTC equivalent used in its place
- [ ] `timezone` imported correctly in the module
- [ ] all existing tests that exercise `automation_registry` pass
- [ ] no `DeprecationWarning` for `utcnow` emitted by this module during test run
- [ ] Typecheck passes
...
**Acceptance Criteria:**
- [ ] `datetime.utcnow()` does not appear in `rex/service_supervisor.py`
- [ ] timezone-aware UTC equivalent used in its place
- [ ] `timezone` imported correctly in the module
- [ ] all existing tests that exercise `service_supervisor` pass
- [ ] no `DeprecationWarning` for `utcnow` emitted by this module during test run
- [ ] Typecheck passes
