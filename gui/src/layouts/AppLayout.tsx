  ...
  },
  {
    ...
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        ...
        <polyline points="9 22 9 12 15 12 15 22" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
      </svg>
    )
  },
  {
...
const sectionNames: Record<string, string> = {
  ...
  '/settings/home-assistant': 'Home Assistant Settings',
