...
import type { GeneralSettings, VoiceSettings, AiSettings, NotificationsSettings, Settings, VersionInfo, PreferenceSuggestion, VoiceInfo, WakeWordInfo, WakeWordStatus, VoiceEnrollment, Memory, SmartSpeaker, SystemSettings } from '../types/ipc'
