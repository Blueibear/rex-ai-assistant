...
- See `docs/mobile/DEVICE_PAIRING.md`, `docs/mobile/MOBILE_API_SETUP_WINDOWS.md`, `tests/mobile_api/test_pairing.py`, `tests/mobile_api/test_grant_enforcement.py`, `tests/mobile_api/test_tls.py`, and `tests/mobile_api/test_transport_binding.py`.
