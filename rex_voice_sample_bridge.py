"""Compatibility entrypoint for ``bridge/rex_voice_sample_bridge.py``.
...
# The canonical default preview phrase is "Hello, I'm your Rex assistant."

_BRIDGE_PATH = Path(__file__).resolve().parent / "bridge" / "rex_voice_sample_bridge.py"
