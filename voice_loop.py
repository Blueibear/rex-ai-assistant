...
class AsyncRexAssistant:
    ...
    def _speak_response(self, text: str) -> None:
        ...
        # Playback section — separate from synthesis so errors are clearly attributed
        ...
        try:
            ...
            if sounddevice_mod is not None:
                # sounddevice supports device selection by index or name
                sounddevice_mod.play(
                    combined_audio, sample_rate, device=output_device, blocking=True
                )
                sounddevice_mod.stop()
