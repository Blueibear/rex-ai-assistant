"""Compatibility entrypoint for ``bridge/rex_stt_bridge.py``.
...
# The canonical implementation supports the "auto" device setting from config.

_BRIDGE_PATH = Path(__file__).resolve().parent / "bridge" / "rex_stt_bridge.py"
