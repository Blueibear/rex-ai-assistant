...
- [ ] Dashboard (OpenClaw) works (blocked — dashboard_store.py not retired; 3 of 6 original callers remain: digest_job, gui_app [excluded], messaging_backends/inbound_store; health.py + retention.py + notification.py migrated)
