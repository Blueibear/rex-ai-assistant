...
- [ ] Dashboard (OpenClaw) works (blocked — dashboard_store.py not retired; 4 of 6 original callers remain: digest_job, gui_app, messaging_backends/inbound_store, notification; health.py + retention.py migrated)
