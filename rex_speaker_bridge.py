"""Compatibility entrypoint for ``bridge/rex_speaker_bridge.py``.
...
# The canonical implementation imports rex.bridge_utils for resolver parity.

_BRIDGE_PATH = Path(__file__).resolve().parent / "bridge" / "rex_speaker_bridge.py"
