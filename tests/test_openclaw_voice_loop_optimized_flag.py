"""Tests for US-P6-011: USE_OPENCLAW_VOICE_BACKEND flag in rex/voice_loop_optimized.py.
...
class TestVoiceLoopOptimizedFlagOff:
...
class TestVoiceLoopOptimizedFlagOn:
    """When use_openclaw_voice_backend=True, _assistant is replaced with VoiceBridge."""
