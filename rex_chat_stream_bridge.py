"""Compatibility entrypoint for ``bridge/rex_chat_stream_bridge.py``.
...
# The canonical implementation imports Assistant and calls Assistant.generate_reply / stream_reply.

_BRIDGE_PATH = Path(__file__).resolve().parent / "bridge" / "rex_chat_stream_bridge.py"
