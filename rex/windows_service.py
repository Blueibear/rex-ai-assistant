...
try:
    ...
    servicemanager = None  # optional Windows-only dependency
    win32event = None  # optional Windows-only dependency
    win32service = None  # optional Windows-only dependency
    win32serviceutil = None  # optional Windows-only dependency
