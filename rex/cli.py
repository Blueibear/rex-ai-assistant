...
""",
    ...
    shopping_list_cmd.set_defaults(func=cmd_shopping, shopping_command="list")
    ...
    shopping_add_cmd.set_defaults(func=cmd_shopping, shopping_command="add")

    shopping_clear_cmd = shopping_subparsers.add_parser(
        "clear",
        help="Clear checked items from the shopping list",
    )
    shopping_clear_cmd.set_defaults(func=cmd_shopping, shopping_command="clear")

    shopping_parser.set_defaults(func=cmd_shopping, shopping_command="list")
    ...
    qa_list_cmd.set_defaults(func=cmd_quick_actions, qa_command="list")
    qa_parser.set_defaults(func=cmd_quick_actions, qa_command="list")
